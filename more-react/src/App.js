...
class App extends Component {
  ...
  updatePassword(event) {
    ...
    const newPassword = event.target.value
      .split("")
      .filter((x) => x.match(App.allowedChars))
      .join("");
    ...
    return (
      <div>
        ...
        <form>
          ...
          <br />I am <strong>most</strong> interested in:&nbsp;
          <input
            type="radio"
            name="interest"
            value="Justice"
            onChange={this.updateRadioButtons}
            checked={this.state.interest === "Justice"}
          />
          Justice&nbsp;
          <input
            type="radio"
            ...
            value="Freedom"
            onChange={this.updateRadioButtons}
            checked={this.state.interest === "Freedom"}
          />
          Freedom&nbsp;
          <input
            type="radio"
            ...
            value="Equanimity"
            onChange={this.updateRadioButtons}
            checked={this.state.interest === "Equanimity"}
          />
          Equanimity
          <br />
