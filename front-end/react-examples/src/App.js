      ...
      <div className="Collatz">
        ...
        <ul>
          {outputArr.map((item, idx) => {
            return <SpecialListItem key={idx}>{item}</SpecialListItem>;
          })}
        </ul>
      </div>
    );
      ...
      <GridDiv>
        <LeftColumn>
          ...
          <p>
            ...
            positive integer, <i>x</i>, repeatedly applying <i>3x + 1</i> if odd
            and <i>x/2</i> if even will eventually led to 1.
          </p>
